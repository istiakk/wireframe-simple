...
$(document).ready(function() {
    ...
    $('.more').each(function() {
        ...
        if(content.length > showChar) {
            ...
            var html = c + '<span class="moreellipses">' + ellipsestext+ '&nbsp;</span><span class="morecontent"><span>' + h + '</span>&nbsp;&nbsp;<center><button href="" class="morelink read-more btn btn-warning">' + moretext + '</button></center></span>';
